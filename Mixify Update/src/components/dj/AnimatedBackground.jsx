...
export default function AnimatedBackground() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      time += 0.005; // Even slower animation
      
      // Create gradient background
      const gradient = ctx.createLinearGradient(0, 0, canvas.width, canvas.height);
      gradient.addColorStop(0, 'rgba(40, 15, 60, 0.93)');   // Dark purple
      gradient.addColorStop(0.5, 'rgba(60, 25, 80, 0.90)'); // Slightly lighter dark purple
      gradient.addColorStop(1, 'rgba(40, 15, 60, 0.93)');   // Dark purple again
